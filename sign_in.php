...
if(isset($_POST['btnLogin'])){
    ...
    if(!VerifyUserAccount($accountNumber, $accountPassword)){
      ...
      while ($User = mysqli_fetch_array($Users)) {
        ...
        Create_Logs("ACCOUNT LOGIN",$User['person_id'], $User['person_code'], "LOGIN","Date and Time of Login: $dateEncoded @ $timeEncoded<br>IP ADDRESS: $ip<br>Sign in through Email",$User['person_id']);
        // END OF LOGS
            ...
            <div class="container-fluid h-100">
                <div class="row flex-row h-100 bg-white">
                    <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                        <div class="lavalite-bg" style="background-image: url('img/auth/login-bg.jpg'); background-position:center;">
                            <div class=""></div>
                        </div>
                    </div>
                           ...
                           <!--  <div class="logo-centered">
                            ...
                            <form method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Email" name="txtEnterUserName" id="txtEnterUserName" value="<?php if(isset($_POST['txtEnterUserName'])) { echo $_POST['txtEnterUserName']; }?>" required>
                                    <i class="ik ik-user"></i>
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="Password" name="txtEnterPassword" id="txtEnterPassword" value="<?php if(isset($_POST['txtEnterPassword'])) { echo $_POST['txtEnterPassword']; }?>" required>
                            ...
                            <div class="sign-btn text-center">
                                <!-- <a href="sign_in_barcode.php" class="btn btn-theme"><i class="fa fa-barcode"></i> Scan Barcode</a> -->

                                <!-- <a href="sign_in_qrcode.php" class="btn btn-theme"><i class="fa fa-qrcode"></i> Scan QR Code</a> -->
                            </div>
