...
if(!isset($_GET['id'])){
    ...
    if($_GET['id'] == ""){
        ...
        while ($User = mysqli_fetch_array($Users)) {
            if($User['person_code'] == $_GET['id']){
                $name = "{$User['last_name']} {$User['affiliation_name']}, {$User['first_name']} {$User['middle_name']}";
            }
        }
    }
}
    ...
    if(!VerifyBarCode($accountNumber, $accountPassword)){
      ...
      while ($User = mysqli_fetch_array($Users)) {
       ...
       $ip = isset($_SERVER['HTTP_CLIENT_IP']) 
        ...
        Create_Logs("ACCOUNT LOGIN",$User['person_id'], $User['person_code'], "LOGIN","Date and Time of Login: $dateEncoded @ $timeEncoded<br>IP ADDRESS: $ip<br>Sign in through QR Code",$User['person_id']);
        // END OF LOGS
                           ...
                           <!--  <div class="logo-centered">
                            ...
                            <form method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="QR CODE" style="display: none;" name="txtEnterUserName" id="txtEnterUserName" value="<?php echo $_GET['id']; ?>" required>
                                    <i class="ik ik-user"></i>
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="ENTER YOUR MPIN" name="txtEnterPassword" id="txtEnterPassword" value="<?php if(isset($_POST['txtEnterPassword'])) { echo $_POST['txtEnterPassword']; }?>" required>
