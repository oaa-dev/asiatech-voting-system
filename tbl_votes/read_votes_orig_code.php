...
while ($CandidatePosition = mysqli_fetch_array($CandidatePositions)) {
	$filterCounter++;
	echo "<div class='row alert alert-success' style='text-align:center;font-weight:bold; color:black;' width='100%;'><div class='col-lg-12'><h5><b>{$CandidatePosition['candidate_position_name']}</b></h5></div></div>";
